...
<head>
  ...
  <script type="text/javascript">
     function cancel() {
      if(confirm("교수 평가 수정을 취소하고 이전 화면으로 돌아가시겠습니까?")==true){
         history.back();
      }
   }
     function rateUpdate(){
        ...
        if(prof_rates == 0){
           ...
           var c_num = ${profRateUpdateForm.c_num};
  ...
  <section id="container">
    ...
    <section id="main-content">
      <main>
         ...
         <h2 style="margin: 18px; color: #A0522D;"><i class="fa fa-star-half-o">&nbsp;</i><strong>교수자 평가 수정</strong></h2>
                  ...
                  <div class="form-panel">
                    <form class="form-horizontal style-form" method="get" id="createClassFormId">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          ${profRateUpdateForm.c_overview}
                        </div>
                      </div>
                      <div class="form-group">
                        <div class="col-sm-2 col-sm-2 control-label">수업일정</div>
                        <div class="col-md-3 col-xs-11">
                          ${profRateUpdateForm.c_s_date} ~ ${profRateUpdateForm.c_e_date}
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        <label class="col-sm-2 col-sm-2 control-label" for="rate_content">교수 평가 내용</label>
                        <div class="col-sm-10">
                          <textarea class="form-control" id="rate_content" name="rate_content" required="required" placeholder="교수 평가 내용을 작성하세요">${profRateUpdateForm.rate_content}</textarea>
                        </div>
                      </div>
                      <div style="margin: 20px"><span>&nbsp;</span></div>
                          <div style="text-align: center;">
                            <button type="button" class="btn btn-theme" onclick="rateUpdate()">평가수정</button>
