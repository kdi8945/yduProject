  	...
  	function notiUpdate() {
		...
		$.ajax({
			...
			success : function(result) {
				...
				if(result > 0){
					alert("수정에 성공하였습니다.");
					location.href="notiList?b_type="+b_type;
				} else{
					alert("수정을 실패하였습니다.");
				}
			}
  ...
  <section id="container">
    <section id="main-content">
      ...
      <section class="wrapper">
        <h3><i class="fa fa-edit">&nbsp;</i>전체 공지사항 수정하기</h3>
        <div class="row mt">
          <div class="col-lg-8 col-md-7 col-sm-7">
            ...
            <!-- 수정하기 버튼 --> 
              <div class="form-send">
                <button type="button" class="btn btn-large btn-primary" onclick="notiUpdate()">수정하기</button>
                <button class="btn btn-theme04" style="background-color: #FF0000;">
					<a href="#" style="color: white;" onclick="notiUpdCancel()">수정취소</a>
				</button>
              </div>
            <!-- 수정하기 취소 버튼  -->
            </form>
