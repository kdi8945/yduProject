...
<head>
  ...
  <script type="text/javascript">
  	function cancel() {
		if(confirm("수업 개설을 취소하고 초기화면으로 돌아가시겠습니까?")==true){
			location.href="classList"; // 개설현황으로 가야됨
		}
	}
		...
		if(re_date <= todayString){ // 모집일 < 오늘
			...
			if(e_time > co_time){ // 시작시간>종료시간
				...
				alert("수업 종료시간이 시작시간과 같습니다.");
		  		...
		  		var params = $("#createClassFormId").serializeArray();
				console.log(params);
				$.ajax({
					url : "createClass",
					data : params,
					...
					success : function(data){
						...
						if(data.resultCode == 0){
							...
							if(confirm(result+" 수업 목록 조회페이지로 돌아가시겠습니까?")==true){
    ...
    <section id="main-content">
		<main>
			<section class="wrapper">
		        <h3><i class="fa fa-angle-right"></i> 수업 개설하기</h3>
		            ...
		            <div class="form-panel">
		              ...
		              <form class="form-horizontal style-form" method="get" id="createClassFormId">
		                ...
		                <div class="form-group">
		                  ...
		                  <div class="col-sm-10">
		                    <input type="text" class="form-control" id="c_name" name="c_name" required="required">
		                  </div>
		                </div>
		                ...
		                <div class="form-group">
		                  ...
		                  <div class="col-sm-10">
		                    <textarea class="form-control" id="c_overview" name="c_overview" required="required" placeholder="수업 개요를 작성하세요"></textarea>
		                  </div>
		                </div>
		                <div class="form-group">
		                  <label class="col-sm-2 col-sm-2 control-label" for="c_re_date">학생모집일</label>
		                  <div class="col-md-3 col-xs-11"">
		                    <input class="form-control form-control-inline input-medium default-date-picker" size="16" type="date" name="c_re_date" id="c_re_date" required="required">
		                  </div>
		                </div>
		                <div class="form-group">
		                  <label class="col-sm-2 col-sm-2 control-label" for="c_s_date">수업시작일</label>
		                  <div class="col-md-3 col-xs-11">
		                    <input class="form-control form-control-inline input-medium default-date-picker" size="16" type="date" name="c_s_date" id="c_s_date" required="required">
		                  </div>
		                </div>
		                <div class="form-group">
		                  <label class="col-sm-2 col-sm-2 control-label" for="c_e_date">수업종료일</label>
		                  <div class="col-md-3 col-xs-11">
		                    <input class="form-control form-control-inline input-medium default-date-picker" size="16" type="date" name="c_e_date" id="c_e_date" required="required">
		                  </div>
		                </div>
		                <div class="form-group">
		                ...
		                <div style="margin: 20px"><span>&nbsp;</span></div>
		                  <div class="form-group">
		                    <div style="text-align: center;">
		                      <button type="button" class="btn btn-theme" onclick="createClass()">수업개설</button>
